...
import logoTT from "../assets/icons/vietnam-post.png";
...
const inform = {
      address: "Ký túc xá Khu A Đông Hòa, Dĩ An, Bình Dương",
      phone: "0353846079",
      email: "khactoan432@gmail.com",
      facebook: "https://www.facebook.com/khactoan432/",
      instagram: "https://www.instagram.com/khactoan432/",
      tiktok: "https://www.tiktok.com/@khactoan432/",
      youtube: "https://www.youtube.com/channel/UCY_EagcDAzqls8BZGEQg0CA",
      hr_mailbox: "email",
};
const Footer = () => {
            ...
            <footer className='bg-[#e0e3e7]'>
                  <div className=' grid grid-cols-1 gap-x-[70px] lg:grid-cols-3 pt-[35px] mx-auto px-4 lg:px-0 container '>
                        <div className='leading-6 '>
                              <img src={logoTT} className='h-[80px] rounded-[40px]' alt='logo-JnT' />
                              <h5 className='mb-4 font-extrabold'>
                                    CÔNG TY TNHH MỘT THÀNH VIÊN CHUYỂN PHÁT NHANH BÁCH KHOA HỒ CHÍ MINH
                              </h5>
                              <div className='text-[12px] mb-1 '>
                                    <p>
                                          Giấy CNĐKKD: 0353846079 - Ngày cấp: 20/6/2023, đăng ký thay đổi lần 02 ngày
                                          20/7/2023
                                    </p>
                  ...
                  <div className='flex justify-center items-center text-center flex-col lg:flex-row text-xs lg:text-sm pb-6'>
                        ...
                        <span className=''>Copyright © 2023 Delivery. All rights reserved</span>
                  </div>
            </footer>
      );
};
