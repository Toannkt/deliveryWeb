            ...
            <div className='m-auto max-w-[1140px]  px-[16px] lg:px-[0px]'>
                  <div className='lg:gap-x-16 lg:grid lg:grid-cols-2 my-[60px]'>
                        <div className='tracking-wide'>
                              <h3 className='text-[32px] font-bold mb-4'>Cuộc sống T&T</h3>
                              <h5 className='text-base text-[#e5a663] font-bold'>
                                    Tại T&T Delivery, mỗi cá nhân là một “mảnh ghép" quan trọng tạo nên bức tranh đa sắc
                                    màu.
                              </h5>
                              <p className='mb-8'>
                                    Chúng ta tự hào được tập hợp lại thành một đội ngũ thạo kỹ năng, chuẩn thái độ, cùng
                                    với phong cách sống hiện đại và hết mình. Với tinh thần đoàn kết và sẵn sàng giúp đỡ
                                    lẫn nhau, chúng ta đang gây dựng một nếp văn hóa làm việc tích cực, sẵn sàng vươn
                                    xa, dẫn đầu và lan tỏa đến nhiều thế hệ tương lai.
                              </p>
