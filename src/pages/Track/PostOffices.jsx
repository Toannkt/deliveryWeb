...
export default function PostOffices() {
      ...
      useEffect(() => {
            ...
            const provinceCode = getProvince.find((province) => province.name.includes(dataWarehouse.province))?.code;
                                          ...
                                          >
                                                <div className='flex flex-row justify-between gap-x-1'>
                                                      ...
                                                      >
                                                            ...
                                                            <span className=' text-lg text-inherit font-semibold min-w-[131px]'>
                                                                  Tìm đường đi
                                                            </span>
                                                      </a>
                                                </div>
