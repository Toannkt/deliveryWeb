...
const coops = [
      {
            ...
            avatar: "https://jtexpress.vn/storage/app/uploads/public/628/374/58a/62837458a31d2598134718.jpg",
            quote: "Nhờ dịch vụ J&T International gửi đi hàng mẫu thành công, nhanh chóng mà vừa rồi tôi đã có được hợp đồng cung cấp sản phẩm cho một công ty ở Mỹ.",
      },
      {
            _id: 2,
            name: "Dương Hoàng Minh",
            description: "Giám đốc công ty dệt may tại Bắc Ninh",
            avatar: "https://jtexpress.vn/storage/app/uploads/public/628/599/24b/62859924bde0b670971722.jpg",
            quote: "J&T International là một trợ thủ đắc lực trong quá trình xuất khẩu thành phẩm sang các nước Đông Nam Á của công ty tôi, đặc biệt là gửi hàng trễ chuyến",
      },
      {
            _id: 3,
            name: "Trần Minh Trí",
            description: "Giám đốc công ty cà phê tại Buôn Ma Thuột",
            avatar: "https://jtexpress.vn/storage/app/uploads/public/628/374/c8b/628374c8ba994977079446.jpg",
            quote: "Gửi hàng mẫu cà phê đi nước ngoài không phải là chuyện dễ để cân đối thu chi, tối ưu chi phí cho công ty. May là công ty chúng tôi tìm được J&T International. Dịch vụ vượt mong đợi với giá cả phải chăng, lại còn hay có ưu đãi.",
      },
      {
            _id: 4,
            name: "Vũ An Phương",
...
const Home = () => {
      ...
      useEffect(() => {
            ...
            const provinceCode = dataProvinces.find((province) => province.name === dataWarehouse.province)?.code;
            ...
            <a href="/">
              ...
              />
                        ...
                        <div>
                              <a href='/'>
                                    <img
                                          src='https://png.pngtree.com/background/20230520/original/pngtree-yellow-truck-is-parked-on-an-empty-gray-background-picture-image_2677685.jpg'
                                          className='w-full h-[200px] md:h-[300px] lg:h-[550px] object-cover'
                                          alt='banner'
                                    />
                              </a>
                        ...
                        <div>
                              <a href='/'>
                                    <img
                                          ...
                                          src='https://omisell.com/vi-vn/wp-content/uploads/sites/2/2021/09/shopee-express.svg'
                                          className='w-full h-[200px] md:h-[300px] lg:h-[550px] object-cover'
                                          alt='banner'
                                    />
                              </a>
              ...
              <span className="font-semibold">{warehouse.street}</span>
                  ...
                  <div className='flex flex-col justify-center items-center py-4 mt-6'>
                        ...
                        <span className='text-sm'>
                              T&T Delivery tự hào đã & đang mở rộng mạng lưới trên khắp đất nước, mang trong mình sứ
                              mệnh vươn ra tầm cỡ thế giới
                        </span>
                  </div>
                        ...
                        <div className='flex flex-col items-center justify-center text-justify gap-y-7 w-full lg:max-w-[500px] py-6 px-3 bg-[#F0B90B] lg:rounded-r-xl'>
                              <Fade left duration={1500}>
                                    ...
                                    <span className=' text-base container tracking-wide px-4 lg:px-6 w-full'>
                                          DELIVERY T&T là thương hiệu chuyển phát nhanh dựa trên sự phát triển của công
                                          nghệ và Internet. Chúng tôi sở hữu mạng lưới rộng khắp nhằm hỗ trợ các hoạt
                                          động giao nhận hàng hóa nhanh chóng không chỉ ở nội thành mà còn ở ngoại thành
                                          và các vùng xa của các tỉnh thành trong cả nước Việt Nam.
                                    </span>
                              </Fade>
                        </div>
                              ...
                              services.map((service) => (
                                    <Link to={`dich-vu/${service._id}`} key={service._id}>
                                          ...
                                          <div className='pt-4 flex flex-col'>
                                                <span className='text-xl font-bold uppercase'>{service.name}</span>
        ...
        <Zoom duration={1000}>
          ...
          ></iframe>
                  ...
                  <div className='relative h-[670px] lg:h-[462px]'>
                        <img
                              src='https://simondecirene.cl/wp-content/uploads/2020/05/Delivery_1920x700.png'
                              alt=''
                        ...
                        <div className='absolute bottom-0 flex flex-col lg:flex-row justify-around items-center gap-y-3 w-full '>
                              <div className='flex flex-col text-center gap-y-5'>
                                    <span className=' text-4xl font-black'>TẢI ỨNG DỤNG</span>
                                    <span className=' text-base font-bold mt-[-12px]'>
                                          Tải ngay App Delivery - Giao Hàng
                                          <br />
