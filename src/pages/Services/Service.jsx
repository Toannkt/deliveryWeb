            ...
            <div className='overflow-hidden'>
                  <section>
                        <div className='h-full   md:h-[650px] lg:h-[700px] w-full  pt-12'>
                              <img
                                    ...
                                    src='https://img1.wallspic.com/crops/7/1/9/4/24917/24917-airline-aerospace_engineering-boeing_737-narrow_body_aircraft-air_travel-2880x1800.jpg'
                                    alt=''
                              />
                        </div>
                        <div className='text-left md:mx-7 mx-3 mt-2'>
                              <h1 className='text-[30px] mb-[12px] font-bold text-[#f0b90c]'>Tổng quan dịch vụ</h1>
                              <span className='  text-base md:text-lg text-justify'>
                                    Sở hữu những ưu điểm vượt trội so với các dịch vụ chuyển phát nhanh hiện có trên thị
                                    trường, T&amp;T Delivery thấu hiểu mọi nhu cầu và mang đến cho khách hàng 5 dịch vụ
                                    với những tiện ích đặc biệt nhất.
                              </span>
                        </div>
                  </section>
                  ...
                  <section className='mt-5'>
                        <div className='relative overflow-hidden w-full h-[414px]'>
                              <img
                                    className='  w-full h-full object-cover '
                                    src='https://gomotive.com/wp-content/uploads/2022/04/MeetCustomer_FullWidth_2x-18.jpeg?w=1440&h=798&crop=1'
                                    alt=''
                              />
                              <img
                        ...
                        <div className='md:mx-44 sm:mx-36 mx-12 mt-2'>
                              <div className='text-center '>
                                    <h1 className='text-[28px] mb-[8px] font-bold text-[#f0b90c]'>Tải ứng dụng T&T</h1>
                                    <span className='  text-base md:text-lg text-justify'>
                                          Tải ngay App T&T - Delivery. Hưởng trọn bộ tính năng giao hàng chỉ với 1 chạm
                                    </span>
                              </div>
