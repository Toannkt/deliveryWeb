            ...
            <section id='layout-content'>
                                    ...
                                    {features.map((feature) => (
                                          <div className='flex item-start' key={feature?._id}>
                                                ...
                                                <div className='flex flex-col ml-4'>
                                                      ...
                                                      <span className='text-justify aos-init'>{feature?.detail}</span>
                                                </div>
                                          </div>
                                    ))}
                        ...
                        <div className='container mx-auto mt-10 lg:mt-0 px-4 lg:px-0 mb-10 lg:mb-0 '>
                              ...
                              <div className='wrapper_objects_service grid  grid-cols-2 gap-[20px]  '>
                                    {participants.map((participant) => (
                                          <div
                                                className='h-[315px] lg:h-[244px]  relative rounded-[10px] overflow-hidden col-span-2 md:col-span-1'
                                                key={participant._id}
                                          >
                                                <img
                                          ...
                                          <Link to='/tu-van/dang-ki-tu-van'>
                                                <button className='flex items-center text-[#f5c736] font-bold justify-center h-full w-full'>
                                                      <ion-icon
                                                            ...
                                                            aria-label='search outline'
                                                      />
                                                      <span className='ml-2  font-bold text-lg'>Đăng ký tư vấn</span>
                                                </button>
                                          </Link>
                                    </span>
                                          ...
                                          <Link to='/tra-cuu/buu-cuc'>
                                                <button className='flex items-center text-[#f5c736] font-bold justify-center h-full w-full'>
                                                      <ion-icon
                                                            ...
                                                            aria-label='search outline'
                                                      />
                                                      <span className='ml-2  font-bold text-lg'>Bưu cục gần nhất</span>
                                                </button>
                                          </Link>
                                    </span>
                              </div>
                        ...
                        <CarouselWrapper effect='fade' dots='true' autoplay autoplaySpeed={3500}>
                              {quotes.map((quote) => (
                                    <div className='relative' key={quote?._id}>
                                          <img
                                                src='https://trucks.mercedesbenzmena.com/media/lilcnleh/180326_2018_trucks___overseas___actros___euro_3_2018_trucks_picture00003_extended.jpg?anchor=center&mode=crop&width=1680&height=800&format=auto&quality=90&rnd=132295963008970000'
                  ...
                  <div className='h-[490px] lg:h-[765px] relative'>
                        ...
                        <div className='absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] w-full lg:w-[825px]'>
                              ...
                              >
                                    J&amp;T Delivery là thương hiệu chuyển phát nhanh dựa trên sự phát triển của công
                                    nghệ và Internet. Chúng tôi sở hữu một mạng lưới rộng khắp nhằm hỗ trợ các hoạt động
                                    giao nhận hàng hóa nhanh chóng và tiện lợi.
                              </span>
                              <iframe
