                  ...
                  <>
                        ...
                        <>
                              <div className='m-auto max-w-[1140px] px-[16px] lg:px-[0px]  mt-[90px] lg:mt-[180px]'>
                                    <h2 className='text-[24px] lg:text-[32px] font-bold mb-6'>{data?.name}</h2>
                                    ...
                                    <article className='tracking-wide'>
                                          ...
                                          <p>
                                                <FontAwesomeIcon className='mr-2 text-[#e5a663]' icon={faHeartPulse} />
                              ...
                              <div className='relative mb-[60px] mt-10 '>
                                    <img src={Images.BOTTOM_BANNER} alt='IMG' className='w-full h-[750px]' />
