...
export default function ContactAdvice() {
      ...
      const handleClick = async () => {
            if (!fullName || !phone || !email || !massage) {
                  setIsValid(false);
                  ...
                  <div className='w-full lg:w-[1111px] lg:translate-y-[-130px] mx-auto lg:rounded-[10px] bg-white'>
                        <div className='flex flex-col  lg:flex-row shadow-xl lg:rounded-[10px]'>
                              <div className='p-4 lg:p-12 basis-1/2 '>
                                    <h5 className='text-[24px] text-center lg:text-left lg:text-[56px] font-bold'>
                                          Liên hệ
                                    </h5>
                                    <span className='text-[#454F5B] mt-4 mb-8 inline-block text-center lg:text-left text-lg'>
                                          J&amp;T Express rất vui vì được tiếp nhận liên hệ của bạn. Có bất cứ điều gì
                                          cần phản hồi/giải đáp, gửi ngay cho chúng mình bên dưới nhé!
                                    </span>
                                                ...
                                                <div className='text-[#161D25]'>
                                                      <div className='flex flex-col mb-6'>
                                                            ...
                                                            <input
                                                                  ...
                                                                  className='custom_input name_input text-base ml-1'
                                                                  type='text'
                                                                  name='name'
                                                      ...
                                                      <div className='flex flex-col mb-6'>
                                                            ...
                                                            <textarea
                                                                  placeholder='Message'
                                                                  name='content'
                                                                  className='custom_textarea pt-2 name_select name_input text-base ml-1'
                                                                  onChange={(e) => setMassage(e.target.value)}
                                                            />
                                                      </div>
                                                      <button
                                                            type='button'
                                                            className='rounded-[2px] bg-[#e5a663] text-white h-[55px] w-full mt-6 text-xl'
                                                            id='btnSubmit'
                                                            onClick={handleClick}
                                                      >
                                                            Gửi
                              ...
                              <div className='bg-[#2E2E31] text-[#FFFFFF] p-4 lg:p-12 basis-1/2 rounded-r-[10px]'>
                                    <h5 className='text-[24px] lg:text-[36px] font-bold mt-2 mb-3 text-white'>
                                          Kết nối với J&amp;T Express
                                    </h5>
                                    <div className='flex items-start'>
                                          ...
                                          <div className='flex flex-col border-b pb-[20px] ml-3 mr-10 border-[#5D6A7A] flex-1'>
                                                <span className=' block mb-2 text-base'>Hotline</span>
                                    ...
                                    <div className='flex items-start mt-[20px]'>
                                          <FontAwesomeIcon icon={faEnvelope} className='mt-2' />
                                          <div className='flex flex-col border-b pb-[20px] ml-3 mr-10 border-[#5D6A7A] flex-1'>
                                                <span className='block mb-2 text-base'>HR email</span>
                                                <span className='font-bold'>{hrMail}</span>
                                          </div>
                                    </div>
                                    <div className='flex items-start mt-[20px]'>
                                          <FontAwesomeIcon icon={faLocationDot} className='mt-2' />
                                          <div className='flex flex-col border-b pb-[20px] ml-3 mr-10 border-[#5D6A7A] flex-1'>
                                                <span className='text-base block mb-2'>Địa chỉ liên hệ</span>
                                    ...
                                    <div className='flex mb-2'>
                                          <a href={contactFacebook} target='_blank'>
                                                <img
                                                      src='https://jtexpress.vn/themes/jtexpress/assets/images/facebook.png'
                                                      alt='facebook'
                                                />
                                          </a>
                                          <a href={contactInsta} target='_blank'>
                                                <img
                                                      src='https://jtexpress.vn/themes/jtexpress/assets/images/Instagram.png'
                                                      alt='Instagram'
                                                />
                                          </a>
                                          <a href={contactTiktok} target='_blank'>
                                                <img
                                                      src='https://jtexpress.vn/themes/jtexpress/assets/images/tiktok.png'
                                                      alt='tiktok'
                                                />
                                          </a>
                                          <a href={contactYoutube} target='_blank'>
                                                <img
                                                      src='https://jtexpress.vn/themes/jtexpress/assets/images/YT.png'
                                                      alt='YT'
                                                />
                                          </a>
                                    </div>
                                    <div className='relative h-full lg:h-[276px]'>
                                          ...
                                          />
                                          <img
                                                className='w-[176px] absolute bottom-0 left-0'
