...
import { getProvincesWithDetail, getProvinces, getWardsByDistrictCode, getDistrictsByProvinceCode } from "sub-vn";
...
export default function SignUpForAdvice() {
      ...
      useEffect(() => {
            for (let i = 0; i < provincesTo?.length; i++)
                  if (provinceCodeTo == provincesTo[i].code) setProvince(provincesTo[i].name);
      });
      useEffect(() => {
            for (let i = 0; i < districtsTo?.length; i++)
                  if (districtCodeTo == districtsTo[i].code) setDistrict(districtsTo[i].name);
      });
      useEffect(() => {
            for (let i = 0; i < wardsTo?.length; i++) if (wardCodeTo == wardsTo[i].code) setWard(wardsTo[i].name);
      });
      //get full address
      useEffect(() => {
            ...
            <div className='layoutAdvice'>
                  ...
                  <div className='w-full lg:w-[1111px] lg:translate-y-[-130px] mx-auto lg:rounded-[10px] bg-white'>
                        <div className='rounded-b-[10px] shadow shadow-[#c2bacc66] lg:px-16 lg:py-16 px-4 '>
                              ...
                              <form className='form-consultant' style={{ overflow: "hidden !important" }}>
                                    ...
                                    <div className=' lg:border-t-2 border-[#F2F2F2] lg:pb-10 lg:pt-6'>
                                          ...
                                          <div className='overflow-hidden mt-5 lg:border border-[#edeff1] p-2'>
                                                      ...
                                                      <div className='w-full mb-4 lg:mb-0'>
                                                            ...
                                                            <div className='w-full  h-[43px]'>
                                                                  <select
                                                                        ...
                                                                        onChange={(e) =>
                                                                              setProvinceCodeTo(e.target.value)
                                                                        }
                                                                  >
                                                                        <option
                                                                              data-select2-id='select2-data-81-rsyi'
                                                                              value=''
                                                                        >
                                                                              Tỉnh/ Thành phố
                                                                        </option>
                                                      ...
                                                      <div className='w-full mb-4 lg:mb-0'>
                                                            ...
                                                            <div className='w-full h-[43px]'>
                                                                  <select
                                                                        className=' h-full w-full '
                                                                        onChange={(e) =>
                                                                              setDistrictCodeTo(e.target.value)
                                                                        }
                                                                  >
                                                ...
                                                <div className='mb-4 lg:mb-6'>
                                                      <span className='text-[16px] text-[#161D25] ml-1'>Phường/xã</span>
                                                      <div className='w-full  h-[43px]'>
                                                            <select
                                                                  id='dropdown-ward'
                                                                  name='ward_id'
                                                            ...
                                                            >
                                                                  <option
                                                                        data-select2-id='select2-data-154-1nut'
                                                                        value=''
                                                                  >
                                                                        Phường/ Xã
                                                                  </option>
