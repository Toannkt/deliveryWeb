...
function About() {
      ...
      const [banners, setBanners] = useState([
            "https://www.larcenter.com.br/wp-content/uploads/sites/3/curriculos/LC-CN-Banner-Home-Site.png",
      ]);
      useEffect(() => {
            setMetadata((prev) => {
                  return {
                        ...prev,
                        title: "Về chúng tôi | T&T",
                  };
            });
      ...
      return (
            <div className='mx-auto'>
                  ...
                  <div className='flex flex-col xl:flex-row justify-between  container mx-auto my-4 lg:mt-[-240px]'>
                        <div>
                              <span
                                    className='block text-2xl text-center font-black my-6 py-4 lg:text-6xl lg:text-left'
                                    style={{ color: "#ff7300" }}
                              >
                                    DELIVERY T&T
                              </span>
                              <div className='text-justify w-full xl:w-[525px] border-4 border-border_color p-8 text-base rounded-2xl lg:bg-yellow-100 opacity-95'>
                                    <span className='whitespace-pre-line'>
                                          ...
                                          nghệ và Internet. Chúng tôi sở hữu một mạng lưới rộng khắp nhằm hỗ trợ các
                                          hoạt động giao nhận hàng hóa nhanh chóng không chỉ ở nội thành mà còn ở ngoại
                                          thành và các vùng xa của các tỉnh thành trong cả nước Việt Nam. Đồng thời,
                                          hiện tại, DELIVERY T&T định hướng mở rộng phạm vi cung cấp các dịch vụ chuyển
                                          phát nhanh ra quốc tế.
                                    </span>
                        ...
                        <div className='flex flex-col-reverse xl:flex-row items-start'>
                              <div className='flex flex-col gap-y-6 xl:order-1 ml-52'>
                                    ...
                                    <span className='text-base'>
                                          {/* {data.vision} */}
                                          DELIVERY T&T là thương hiệu chuyển phát nhanh uy tín và bền vững tại Việt Nam.
                                    </span>
                                    ...
                                    <span className='text-base whitespace-pre-line '>
                                          ...
                                          là ba giá trị cơ bản của DELIVERY T&T nhằm mang đến chất lượng dịch vụ giao
                                          hàng tốt nhất cho khách hàng.
                                          <br />
                                          Chúng tôi cam kết phục vụ một cách trung thực và có trách nhiệm đối với từng
                              ...
                              <div className='xl:max-w-[400px]'>
                                    ...
                                    <div className='p-8 mb-2 border-[3px] border-border_color rounded-2xl bg-yellow-200 shadow-2xl opacity-95'>
                                          <span className='text-base font-semibold text-justify'>
                                                Được thành lập vào năm 2023 tại Bách Khoa HCM, DELIVERY T&T là công ty
                                                chuyển phát nhanh dựa trên công nghệ thông tin và theo xu hướng của
                                                ngành thương mại điện tử.
                                                <br />
                                                Với sự phát triển không ngừng, hiện nay DELIVERY T&T đã có mặt tại 10
                                                quốc gia bao gồm Indonesia, Việt Nam, Malaysia, Thái Lan, Philippines,
                                                Singapore, Cambodia, UAE, Ả Rập Xê-út và Mexico.
                                          </span>
                                    </div>
                              </div>
                  ...
                  <div className='relative w-full lg:px-0  mt-16'>
                        <div className='lg:absolute flex flex-col mx-auto justify-center items-center gap-y-0 lg:gap-y-8 px-4 container lg:left-1/2 lg:-translate-x-1/2 w-full'>
                              ...
                              <span className=' lg:text-base text-justify lg:w-4/5 p-3 shadow-2xl rounded-xl border-[3px] bg-yellow-200 border-border_color tracking-wide'>
                                    Có mặt tại thị trường vào tháng 6/2022, DELIVERY T&T sở hữu một mạng lưới rộng khắp
                                    63 tỉnh thành nhằm hỗ trợ các hoạt động giao nhận hàng hóa nhanh chóng, phủ sóng các
                                    thành phố lớn, khu vực vùng sâu vùng xa hay hải đảo trên toàn lãnh thổ Việt Nam.
                                    Mạng lưới chúng tôi dựa trên nguyên tắc "Không loại trừ bất kỳ vị trí địa lý nào".
                              </span>
                        </div>
                        <img src='https://wallpaperaccess.com/full/520886.jpg' className='w-full h-auto object-cover' />
                  </div>
            </div>
      );
}
